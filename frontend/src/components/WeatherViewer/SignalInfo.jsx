    ...
    <Card sx={{ background: 'rgba(30, 30, 40, 0.6)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 2 }}>
      <CardContent>
        ...
        <Grid container spacing={2}>
          {/* Locks */}
          <Grid item xs={6}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: 1.5, bg: 'rgba(255,255,255,0.02)', borderRadius: 1 }}>
          ...
          <Grid item xs={6}>
            ...
            <LinearProgress 
              ...
              sx={{ height: 6, borderRadius: 3, mt: 1, backgroundColor: 'rgba(255,255,255,0.05)' }} 
            />
          </Grid>
          ...
          <Grid item xs={12}>
            <Box sx={{ display: 'flex', alignItems: 'center', mt: 1, p: 1, borderRadius: 1, border: '1px solid rgba(255,255,255,0.05)', backgroundColor: 'rgba(0,0,0,0.1)' }}>
